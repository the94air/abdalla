	...
	<div class="py-24 md:py-40 text-white">
		<div class="container">
			<div class="full-width md:w-8/12 md:mx-auto">
				<p class="perfect-yellow-text font-title uppercase text-sm mb-4">What i use?</p>
				<div class="mb-16">
			...
			<div class="flex flex-wrap -mx-2">
				<div class="w-1/3 sm:w-1/5 md:w-2/12 lg:w-1/12 px-2 mb-6" v-for="icon in icons" :key="icon.id">
